...
class FetchSignal extends EventEmitter {
	constructor() {
		super();
		this[ABORTED] = false;
	}
...
export { Headers, Request, Response, FetchError, AbortError, FetchController, FetchSignal };export default fetch;
